...
use openagent_terminal_config_derive::SerdeReplace;
use openagent_terminal_core::term::color::COUNT;
use openagent_terminal_core::vte::ansi::{NamedColor, Rgb as VteRgb};
