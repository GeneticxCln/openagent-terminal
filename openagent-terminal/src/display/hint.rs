...
use openagent_terminal_core::grid::{BidirectionalIterator, Dimensions};
use openagent_terminal_core::index::{Boundary, Column, Direction, Line, Point};
use openagent_terminal_core::term::cell::Hyperlink;
use openagent_terminal_core::term::search::{Match, RegexIter, RegexSearch};
