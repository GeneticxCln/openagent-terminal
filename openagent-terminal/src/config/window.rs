...
/// Default application name, used for window title and class.
pub const DEFAULT_NAME: &str = "OpenAgent Terminal";
...
impl Default for Class {
    fn default() -> Self {
        // Use a stable, lowercase class/app_id without spaces for desktop integration.
        Self::new("openagent-terminal", "openagent-terminal")
    }
}
